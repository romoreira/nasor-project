...
; <label>:29:                                     ; preds = %17
  ...
  call void @llvm.dbg.value(metadata i8* %14, metadata !141, metadata !DIExpression(DW_OP_plus_uconst, 62, DW_OP_stack_value)), !dbg !204
  %30 = getelementptr i8, i8* %14, i64 78, !dbg !205
  %31 = icmp ugt i8* %30, %10, !dbg !206
  br i1 %31, label %38, label %32, !dbg !207

; <label>:32:                                     ; preds = %29
  %33 = getelementptr inbounds [48 x i8], [48 x i8]* %5, i64 0, i64 0, !dbg !208
  call void @llvm.lifetime.start.p0i8(i64 48, i8* nonnull %33) #3, !dbg !208
  call void @llvm.dbg.declare(metadata [48 x i8]* %5, metadata !157, metadata !DIExpression()), !dbg !208
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %33, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @xdp_parser_func.____fmt.2, i64 0, i64 0), i64 48, i32 1, i1 false), !dbg !208
  %34 = getelementptr inbounds i8, i8* %14, i64 77, !dbg !208
  %35 = load i8, i8* %34, align 1, !dbg !208, !tbaa !209
  %36 = zext i8 %35 to i32, !dbg !208
  %37 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %33, i32 48, i32 %36) #3, !dbg !208
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %33) #3, !dbg !210
  br label %41, !dbg !211

; <label>:38:                                     ; preds = %29
  %39 = getelementptr inbounds [22 x i8], [22 x i8]* %6, i64 0, i64 0, !dbg !212
  call void @llvm.lifetime.start.p0i8(i64 22, i8* nonnull %39) #3, !dbg !212
  call void @llvm.dbg.declare(metadata [22 x i8]* %6, metadata !164, metadata !DIExpression()), !dbg !212
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull %39, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @xdp_parser_func.____fmt.3, i64 0, i64 0), i64 22, i32 1, i1 false), !dbg !212
  %40 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %39, i32 22) #3, !dbg !212
  call void @llvm.lifetime.end.p0i8(i64 22, i8* nonnull %39) #3, !dbg !213
  br label %41, !dbg !214

; <label>:41:                                     ; preds = %1, %32, %38, %26
  %42 = bitcast i32* %2 to i8*, !dbg !215
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %42), !dbg !215
  call void @llvm.dbg.value(metadata i32 2, metadata !221, metadata !DIExpression()) #3, !dbg !215
  store i32 2, i32* %2, align 4, !tbaa !232
  %43 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %42) #3, !dbg !233
  call void @llvm.dbg.value(metadata i8* %43, metadata !222, metadata !DIExpression()) #3, !dbg !234
  %44 = icmp eq i8* %43, null, !dbg !235
  br i1 %44, label %58, label %45, !dbg !237

; <label>:45:                                     ; preds = %41
  %46 = bitcast i8* %43 to i64*, !dbg !238
  %47 = load i64, i64* %46, align 8, !dbg !239, !tbaa !240
  %48 = add i64 %47, 1, !dbg !239
  store i64 %48, i64* %46, align 8, !dbg !239, !tbaa !240
  %49 = load i32, i32* %7, align 4, !dbg !243, !tbaa !172
  %50 = load i32, i32* %11, align 4, !dbg !244, !tbaa !181
  %51 = sub i32 %49, %50, !dbg !245
  %52 = zext i32 %51 to i64, !dbg !246
  %53 = getelementptr inbounds i8, i8* %43, i64 8, !dbg !247
  %54 = bitcast i8* %53 to i64*, !dbg !247
  %55 = load i64, i64* %54, align 8, !dbg !248, !tbaa !249
  %56 = add i64 %55, %52, !dbg !248
  store i64 %56, i64* %54, align 8, !dbg !248, !tbaa !249
  %57 = load i32, i32* %2, align 4, !dbg !250, !tbaa !232
  call void @llvm.dbg.value(metadata i32 %57, metadata !221, metadata !DIExpression()) #3, !dbg !215
  br label %58, !dbg !251

; <label>:58:                                     ; preds = %41, %45
  %59 = phi i32 [ %57, %45 ], [ 0, %41 ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %42), !dbg !252
  ret i32 %59, !dbg !253
}
...
!208 = !DILocation(line: 143, column: 4, scope: !158)
!209 = !{!175, !175, i64 0}
!210 = !DILocation(line: 143, column: 4, scope: !159)
!211 = !DILocation(line: 156, column: 2, scope: !145)
!212 = !DILocation(line: 152, column: 4, scope: !165)
!213 = !DILocation(line: 152, column: 4, scope: !166)
!214 = !DILocation(line: 153, column: 4, scope: !166)
!215 = !DILocation(line: 24, column: 57, scope: !216, inlinedAt: !231)
!216 = distinct !DISubprogram(name: "xdp_stats_record_action", scope: !44, file: !44, line: 24, type: !217, isLocal: true, isDefinition: true, scopeLine: 25, flags: DIFlagPrototyped, isOptimized: true, unit: !2, variables: !219)
!217 = !DISubroutineType(types: !218)
!218 = !{!35, !60, !35}
!219 = !{!220, !221, !222}
!220 = !DILocalVariable(name: "ctx", arg: 1, scope: !216, file: !44, line: 24, type: !60)
!221 = !DILocalVariable(name: "action", arg: 2, scope: !216, file: !44, line: 24, type: !35)
!222 = !DILocalVariable(name: "rec", scope: !216, file: !44, line: 30, type: !223)
!223 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !224, size: 64)
!224 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "datarec", file: !225, line: 10, size: 128, elements: !226)
!225 = !DIFile(filename: "./../common/xdp_stats_kern_user.h", directory: "/home/ubuntu/EdgeComputingSlice/urllc/packet01-parsing")
!226 = !{!227, !230}
!227 = !DIDerivedType(tag: DW_TAG_member, name: "rx_packets", scope: !224, file: !225, line: 11, baseType: !228, size: 64)
!228 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u64", file: !17, line: 31, baseType: !229)
!229 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!230 = !DIDerivedType(tag: DW_TAG_member, name: "rx_bytes", scope: !224, file: !225, line: 12, baseType: !228, size: 64, offset: 64)
!231 = distinct !DILocation(line: 169, column: 9, scope: !57)
!232 = !{!174, !174, i64 0}
!233 = !DILocation(line: 30, column: 24, scope: !216, inlinedAt: !231)
!234 = !DILocation(line: 30, column: 18, scope: !216, inlinedAt: !231)
!235 = !DILocation(line: 31, column: 7, scope: !236, inlinedAt: !231)
!236 = distinct !DILexicalBlock(scope: !216, file: !44, line: 31, column: 6)
!237 = !DILocation(line: 31, column: 6, scope: !216, inlinedAt: !231)
!238 = !DILocation(line: 38, column: 7, scope: !216, inlinedAt: !231)
!239 = !DILocation(line: 38, column: 17, scope: !216, inlinedAt: !231)
!240 = !{!241, !242, i64 0}
!241 = !{!"datarec", !242, i64 0, !242, i64 8}
!242 = !{!"long long", !175, i64 0}
!243 = !DILocation(line: 39, column: 25, scope: !216, inlinedAt: !231)
!244 = !DILocation(line: 39, column: 41, scope: !216, inlinedAt: !231)
!245 = !DILocation(line: 39, column: 34, scope: !216, inlinedAt: !231)
!246 = !DILocation(line: 39, column: 19, scope: !216, inlinedAt: !231)
!247 = !DILocation(line: 39, column: 7, scope: !216, inlinedAt: !231)
!248 = !DILocation(line: 39, column: 16, scope: !216, inlinedAt: !231)
!249 = !{!241, !242, i64 8}
!250 = !DILocation(line: 41, column: 9, scope: !216, inlinedAt: !231)
!251 = !DILocation(line: 41, column: 2, scope: !216, inlinedAt: !231)
!252 = !DILocation(line: 42, column: 1, scope: !216, inlinedAt: !231)
!253 = !DILocation(line: 169, column: 2, scope: !57)
